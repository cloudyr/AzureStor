...
(As of November 2018, Azure Data Lake Storage Gen2 is in limited-access public preview. If you are not enrolled in the preview program, you can skip over any mentions of ADLSgen2 in this vignette.)
...
Currently, the client interface for AzureStor only supports blob storage, file storage, and Azure Data Lake  storage gen 2. For blobs, only block-blob uploading is supported.
