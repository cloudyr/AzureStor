...
#' @param retries The number of times the file transfer functions will retry a transfer if it fails. Set this to 0 to disable retries. This is applied per block for uploading, and to the entire blob for downloading.
